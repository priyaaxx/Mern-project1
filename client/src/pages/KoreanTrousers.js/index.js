...
import FiltersShirts from "../Shirts/FiltersShirts"; // Assuming you have a FiltersShirts component
...
function KoreanTrousers() {
  ...
  const [filters, setFilters] = useState({
    status: "approved",
    category: ["Women", "Men"], // Both men and women's shirts
    age: [],
    itemType: ["Pants"], // Only shirts
    material: [],
    color: [],
