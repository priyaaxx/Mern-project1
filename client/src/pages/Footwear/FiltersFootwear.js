...
const FiltersFootwear = ({ showFilters, setShowFilters, filters, setFilters, fetchData }) => {
      ...
      <FormGroup>
        {itemTypes.map((item) => (
          <FormControlLabel
            ...
            control={
              <Checkbox
                checked={filters.itemType.includes(item.value)}
...
export default FiltersFootwear;
